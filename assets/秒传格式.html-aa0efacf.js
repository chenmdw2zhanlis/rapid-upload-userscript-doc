import{_ as a,o as e,c as d,f as n}from"./app-af2d5788.js";const i={},c=n(`<h1 id="秒传格式" tabindex="-1"><a class="header-anchor" href="#秒传格式" aria-hidden="true">#</a> 秒传格式</h1><h2 id="梦姬标准-标准码" tabindex="-1"><a class="header-anchor" href="#梦姬标准-标准码" aria-hidden="true">#</a> 梦姬标准/标准码</h2><div class="language-plain" data-ext="plain"><pre class="language-plain"><code>格式: [md5]#[md5s(可省略)]#[文件大小(byte)]#[文件名] (md5和md5s是字母数字组成的32个字符)
示例:
